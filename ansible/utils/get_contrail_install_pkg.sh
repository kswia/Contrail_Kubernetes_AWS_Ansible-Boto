...
echo "Modify k8s cluster name...................................."
sed -i "s/k8s-default/k8sCluster/g" /root/contrail-ansible/playbooks/roles/node/vars/main.yml
...
git clone https://github.com/kswia/kubernetes-demo.git
echo "Done"
